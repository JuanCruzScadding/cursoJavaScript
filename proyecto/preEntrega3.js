...
const peliculas = [
  { titulo: "Título 1", genero: "Género 1" },
  { titulo: "Título 2", genero: "Género 2" },
  { titulo: "Título 3", genero: "Género 3" },
...
function obtenerResultadosSimulados() {
  return new Promise(resolve => {
    // Simulamos una demora de 1 segundo para obtener los resultados
    setTimeout(() => {
      resolve(peliculas);
    }, 500);
  });
